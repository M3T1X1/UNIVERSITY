...
n        equ 6
         ...
         jne next1   ; jump if not equal  ; jump if ecx != 0 ; jump if ZF = 0
...
next1    cmp ecx, 1  ; ecx - 1            ; OF SF ZF AF PF CF affected
         jne next2   ; jump if not equal  ; jump if ecx != 1 ; jump if ZF = 0
...
next2    cmp ecx, 2  ; ecx - 2            ; OF SF ZF AF PF CF affected
         jne next3   ; jump if not equal  ; jump if ecx != 2 ; jump if ZF = 0
