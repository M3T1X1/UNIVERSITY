...
addr_x2  dq x    ; [ ][ ][ ][ ][ ][ ][ ][ ]  ; addr_x2 = addr_y + 16
...
;        st = []  ; fpu stack
         ...
         fld qword [ebp+16]  ; *(double*)(ebp+16) = *(double*)addr_x2 = x -> st = [x2, x, y]  ;

;        st = [st0, st1, st2] = [x2, x, y]
...
;        st2 -> y
         ...
         fmulp st1   ; st1 = st1 * st0 and pop = x * x = x^2
